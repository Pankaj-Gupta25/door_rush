...
const (
	TrackingService_GetTrackingDetails_FullMethodName = "/tracking.TrackingService/GetTrackingDetails"
)
...
func (c *trackingServiceClient) GetTrackingDetails(ctx context.Context, in *GetTrackingDetailsRequest, opts ...grpc.CallOption) (*GetTrackingDetailsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTrackingDetailsResponse)
	err := c.cc.Invoke(ctx, TrackingService_GetTrackingDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrackingServiceServer) GetTrackingDetails(context.Context, *GetTrackingDetailsRequest) (*GetTrackingDetailsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTrackingDetails not implemented")
}
...
func _TrackingService_GetTrackingDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTrackingDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrackingServiceServer).GetTrackingDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrackingService_GetTrackingDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrackingServiceServer).GetTrackingDetails(ctx, req.(*GetTrackingDetailsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TrackingService_GetTrackingDetails_Handler,
		},
	},
